...
def resolve_path(current_dir: str, file: str) -> str:
    ...
    if "packages/papervec" in current_dir.replace("\\", "/"):
        # Local setup: E.g. ArXivFlow/packages/papervec/src/lib/allenai/main.py
        project_root = os.path.abspath(os.path.join(current_dir, "../../../../.."))
    else:
        # Docker setup: E.g. /app/src/lib/allenai/main.py
        project_root = os.path.abspath(os.path.join(current_dir, "../../.."))
