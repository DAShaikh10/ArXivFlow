...
SEMANTIC_SCHOLAR_BATCH_SIZE = int(os.getenv("SEMANTIC_SCHOLAR_BATCH_SIZE", "100"))
SEMANTIC_SCHOLAR_CONCURRENCY = int(os.getenv("SEMANTIC_SCHOLAR_CONCURRENCY", "1"))
SEMANTIC_SCHOLAR_DELAY_BETWEEN_BATCHES = int(os.getenv("SEMANTIC_SCHOLAR_DELAY_BETWEEN_BATCHES", "3"))
